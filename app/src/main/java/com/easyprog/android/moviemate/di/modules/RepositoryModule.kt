...
abstract class RepositoryModule {
    ...
    @Singleton
    @Binds
    abstract fun provideMovieRepository(movieListRepositoryImpl: MovieListListRepositoryImpl): MovieListRepository
    ...
    @Singleton
    @Binds
    abstract fun provideMoviesByCategoryRepository(moviesByGenreRepositoryImpl: MoviesByGenreRepositoryImpl): MoviesByGenreRepository
